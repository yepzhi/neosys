const translations = {
    es: {
        ...
        m2_title: "II. CULTIVARÁS LA CURIOSIDAD\nCOMO VIRTUD.",
        ...
        m4_title: "IV. DEFENDERÁS LA EVIDENCIA\nCOMO BRÚJULA.",
        ...
        m6_title: "VI. CUIDARÁS LA TIERRA COMO\nTU ÚNICO HOGAR COMPROBADO.",
        m6_body: "No hay otro cercano; protegerlo es un acto de razón y de responsabilidad.",
        m7_title: "VII. AMARÁS LA VIDA\nDONDE EXISTA.",
    ...
    en: {
        ...
        poster_download_btn: "Download Principles Poster (v4.1)",

        m1_title: "I. HONOR TRUTH\nABOVE COMFORT.", m1_body: "Seek reality over false certainty.",
        m2_title: "II. CULTIVATE CURIOSITY\nAS A VIRTUE.", m2_body: "Ask before asserting.",
        m3_title: "III. REMEMBER THAT YOU\nARE STARDUST.", m3_body: "You are the universe made conscious.",
        m4_title: "IV. DEFEND EVIDENCE\nAS COMPASS.", m4_body: "The most reliable filter we have.",
        m5_title: "V. PRACTICE COSMIC\nHUMILITY.", m5_body: "Reject ego, embrace wonder.",
        m6_title: "VI. CARE FOR THE EARTH AS\nYOUR ONLY HOME.", m6_body: "Protecting it is an act of reason.",
        m7_title: "VII. LOVE LIFE\nWHERE IT EXISTS.", m7_body: "Every form of life deserves dignity.",
        m8_title: "VIII. DON'T TURN MYSTERY\nINTO IGNORANCE.", m8_body: "Invite understanding.",
        m9_title: "IX. TRANSMIT\nKNOWLEDGE.", m9_body: "Share what is learned.",
        m10_title: "X. DON'T BE A MERE OBSERVER:\nBE A BUILDER.", m10_body: "Apply knowledge to generate impact.",
        ...
        join_badge_phrase1: "Without science there is no clarity. Without validation no progress.",
        join_badge_phrase2: "An open framework to understand reality through evidence.",
        join_badge_phrase3: "Get to know the 10 principles of the Cosmos today!",
