const translations = {
    es: {
        ...
        prob_title: "Cuatro oportunidades en la generación, validación<br><span class='text-accent'>y aplicación del conocimiento</span>",
        prob1_title: "✨ Restauración de la Cultura Epistémica",
        prob1_body: "Superar la posverdad y las cámaras de eco priorizando hechos verificables sobre creencias cómodas.",
        prob2_title: "🔗 Sincronización Conocimiento-Acción",
        prob2_body: "Eliminar la inercia institucional traduciendo el saber en resultados medibles e impacto real.",
        prob3_title: "🔬 Validación Sistemática y Rigurosa",
        prob3_body: "Combatir la pseudociencia y los sesgos mediante procesos de comprobación constantes y transparencia.",
        prob4_title: "📉 Alineación de Saber y Valor",
        prob4_body: "Cerrar la brecha entre investigación y práctica para que el conocimiento sólido guíe las decisiones colectivas.",
        ...
        join_phone: "WhatsApp / Teléfono (opcional)",
        join_social: "@ Red social favorita (opcional)",
    ...
    en: {
        ...
        join_phone: "WhatsApp / Phone (optional)",
        join_social: "@ Favorite social media (optional)",
    ...
    cn: {
        ...
        prob_label: "四個機會",
        prob_title: "知識生成、驗證和應用的<br><span class='text-accent'>四個機會</span>",
        prob1_title: "✨ 恢復認識論文化",
        prob1_body: "通過優先考慮可驗證的事實而非舒適的信念，克服後真相和回聲室。",
        prob2_title: "🔗 知識-行動同步",
        prob2_body: "通將知識轉化為可衡量的結果和真正的影響，消除機構慣性。",
        prob3_title: "🔬 系統化和嚴格驗證",
        prob3_body: "通過不斷的驗證過程和透明度來對抗偽科學和偏見。",
        prob4_title: "📉 知識與價值的對齊" ,
        prob4_body: "縮小研究與實踐之間的差距，讓堅實的知識指引集體決策。",
        ...
        join_email: "您的電子郵件地址",
        join_phone: "WhatsApp / 電話（可選）",
        join_social: "@ 最喜歡的社交媒體（可選）",
