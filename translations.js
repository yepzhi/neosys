const translations = {
    es: {
        ...
        m1_title: "I. RECONOCERÁS TU\nPROPIA IGNORANCIA.",
        m1_body: "No adorarás la certeza falsa; buscarás lo real, aunque incomode.",
        m2_title: "II. PRIORIZARÁS LA\nEVIDENCIA SOBRE LA FE.",
    ...
    en: {
        ...
        m1_title: "I. ACKNOWLEDGE YOUR\nOWN IGNORANCE.", m1_body: "Seek reality over false certainty.",
        m2_title: "II. PRIORITIZE EVIDENCE\nOVER FAITH.", m2_body: "Ask before asserting.",
        m3_title: "III. REMEMBER THAT YOU ARE\nSTARDUST.", m3_body: "You are the universe made conscious.",
        m4_title: "IV. DO NOT ACCEPT TRUTHS\nWITHOUT VALIDATION.", m4_body: "The most reliable filter we have.",
        m5_title: "V. SEEK THE FLAW\nIN EVERY MODEL.", m5_body: "Reject ego, embrace wonder.",
        m6_title: "VI. TRANSMIT KNOWLEDGE\nWITHOUT BARRIERS.", m6_body: "Protecting it is an act of reason.",
        m7_title: "VII. ACT WITH SYSTEMIC\nRESPONSIBILITY.", m7_body: "Every form of life deserves dignity.",
        m8_title: "VIII. RECOGNIZE THE OTHER\nAS A VALID OBSERVER.", m8_body: "Invite understanding.",
        m9_title: "IX. FOSTER STRUCTURED\nCURIOSITY.", m9_body: "Share what is learned.",
        m10_title: "X. EVOLVE BEFORE\nNEW EVIDENCE.", m10_body: "Apply knowledge to generate real impact, improve conditions, and expand future possibilities.",
        ...
        join_badge_phrase3: "Learn the 10 core principles of the Cosmos today!",
        ...
        m9_title: "IX. 培養有組織的\n好奇心。",
        m10_title: "X. 在新證據\n面前進化。",
        m1_body: "接受我們對事物運作方式的理解仍然有限且不完善。",
        m2_body: "接受一種說法，並非因為希望它是真的，而是因為有證據證明它是真的。",
        m3_body: "我們是宇宙的一部分，正在觀察自身；生物學與宇宙學是一體的。",
        m4_body: "除非有一組可供第三方審查的客觀理由支持，否則不賦予某事真相的價值。",
        m5_body: "只有當一個模型包含可能被證明是錯誤的機制時，它才是有效的。",
        m6_body: "如果不共用並接受挑戰，任何有效模型都是不完整的。",
        m7_body: "意識到任何個人行為都會對整體產生影響；採取連貫一致的行動。",
        m8_body: "每個意識個體都是理解現實的一個獨特窗口；重視數據，而非等級制度。",
        m9_body: "問『為什麼？』和『它是如何工作的？』，同時尋找可重複和可測量的答案。",
        m10_body: "當目前的模型不再能解釋觀察到的現實時，放棄它。",
        join_label: "成為一部分",
