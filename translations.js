const translations = {
    es: {
        ...
        join_badge_desc: "Sube tu foto y escribe tu nombre para crear tu gafete digital del movimiento. Compártelo directo a redes con <strong>#NeosysAeon</strong>",
    ...
    en: {
        ...
        join_badge_desc: "Upload your photo and enter your name to create your digital badge for the movement. Share it directly to social media with <strong>#NeosysAeon</strong>",
    ...
    cn: {
        ...
        join_badge_desc: "上傳你的照片並輸入你的名字，創建你的運動數字徽章。直接分享到社交媒體 <strong>#NeosysAeon</strong>",
